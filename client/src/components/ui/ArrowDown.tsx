...
export function ArrowDown({ targetSectionId }: { targetSectionId?: string }) {
  ...
  return (
    <button
      ...
      className="fixed bottom-8 left-1/2 -translate-x-1/2 animate-bounce cursor-pointer rounded-full p-2 transition-all hover:scale-125 hover:bg-accent/20 z-[60]"
    >
